...
public class qryTradingAccountXml {
    ...
    public static Collection usernameData() {
        ...
        for(String s:MessageHandler.getHandler().msg.keySet()){
          if(MessageHandler.getHandler().msg.get(s).getCasename().equals("qryTradingAccountXml")){
    ...
    @Before
    public void bofore() {
        logger.info("bofore qryTradingAccountXml");
    }
