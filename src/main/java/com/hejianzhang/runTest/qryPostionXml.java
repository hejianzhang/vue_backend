...
public class qryPostionXml {
    ...
    public static Collection usernameData() {
        ...
        for(String s:MessageHandler.getHandler().msg.keySet()){
          if(MessageHandler.getHandler().msg.get(s).getCasename().equals("qryPostionXml")){
