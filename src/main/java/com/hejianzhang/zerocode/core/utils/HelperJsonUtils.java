...
public class HelperJsonUtils {
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(com.hejianzhang.zerocode.core.utils.HelperJsonUtils.class);
    ...
    private void setRequestHeaders(Object headers, ClientRequest clientExecutor) {
        Map<String, Object> headersMap = com.hejianzhang.zerocode.core.utils.HelperJsonUtils.readObjectAsMap(headers);
