...
public class ZeroCodeChartKeyValueArrayBuilder {
    ...
    public static com.hejianzhang.zerocode.core.domain.builders.ZeroCodeChartKeyValueArrayBuilder newInstance() {
        return new com.hejianzhang.zerocode.core.domain.builders.ZeroCodeChartKeyValueArrayBuilder();
    }
    ...
    */
    ...
    public com.hejianzhang.zerocode.core.domain.builders.ZeroCodeChartKeyValueArrayBuilder kvs(List<ZeroCodeChartKeyValue> kvs) {
        this.kvs = kvs;
        return this;
    }

    public com.hejianzhang.zerocode.core.domain.builders.ZeroCodeChartKeyValueArrayBuilder kv(ZeroCodeChartKeyValue kv) {
        this.kvs.add(kv);
        return this;
    }
