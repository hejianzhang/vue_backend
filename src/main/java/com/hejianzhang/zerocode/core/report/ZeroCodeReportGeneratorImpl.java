...
import com.hejianzhang.zerocode.core.domain.builders.*;
...
import com.hejianzhang.zerocode.core.report.HighChartColumnHtmlWriter;
...
import static com.hejianzhang.zerocode.core.domain.builders.ExtentReportsFactory.getReportName;
...
public class ZeroCodeReportGeneratorImpl implements ZeroCodeReportGenerator {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.hejianzhang.zerocode.core.report.ZeroCodeReportGeneratorImpl.class);
