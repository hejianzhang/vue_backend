...
import static com.hejianzhang.zerocode.core.domain.reports.ZeroCodeReportProperties.TARGET_FULL_REPORT_DIR;
import static org.slf4j.LoggerFactory.getLogger;

public class HighChartColumnHtmlWriter {
    private static final org.slf4j.Logger LOGGER = getLogger(com.hejianzhang.zerocode.core.report.HighChartColumnHtmlWriter.class);
