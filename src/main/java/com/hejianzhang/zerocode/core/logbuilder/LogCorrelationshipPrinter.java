...
import com.hejianzhang.zerocode.core.domain.builders.ZeroCodeReportStepBuilder;
import com.hejianzhang.zerocode.core.domain.reports.ZeroCodeReportStep;
import com.hejianzhang.zerocode.core.logbuilder.RequestLogBuilder;
import com.hejianzhang.zerocode.core.logbuilder.ResponseLogBuilder;
import com.hejianzhang.zerocode.core.logbuilder.ScenarioLogBuilder;
...
import static com.hejianzhang.zerocode.core.domain.reports.ZeroCodeReportProperties.*;
...
public class LogCorrelationshipPrinter {
    ...
    public static com.hejianzhang.zerocode.core.logbuilder.LogCorrelationshipPrinter newInstance(Logger logger) {
        return new com.hejianzhang.zerocode.core.logbuilder.LogCorrelationshipPrinter(logger);
    }
    ...
    public com.hejianzhang.zerocode.core.logbuilder.LogCorrelationshipPrinter assertion(String assertionJson){
        responseLogBuilder.assertionSection(assertionJson);
        return this;
    }

    public com.hejianzhang.zerocode.core.logbuilder.LogCorrelationshipPrinter stepLoop(Integer stepLoop) {
        this.stepLoop = stepLoop;
        return this;
    }

    public com.hejianzhang.zerocode.core.logbuilder.LogCorrelationshipPrinter result(Boolean result) {
        this.result = result;
        return this;
    }
