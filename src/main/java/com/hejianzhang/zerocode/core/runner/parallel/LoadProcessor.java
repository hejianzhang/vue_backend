package com.hejianzhang.zerocode.core.runner.parallel;

import com.hejianzhang.zerocode.parallel.ExecutorServiceRunner;
...
public class LoadProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.hejianzhang.zerocode.core.runner.parallel.LoadProcessor.class);
    ...
    public com.hejianzhang.zerocode.core.runner.parallel.LoadProcessor addTest(Class<?> testClass, String testMethod) {
