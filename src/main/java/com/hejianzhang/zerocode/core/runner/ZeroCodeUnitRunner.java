...
import com.hejianzhang.zerocode.core.domain.*;
...
public class ZeroCodeUnitRunner extends BlockJUnit4ClassRunner {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.hejianzhang.zerocode.core.runner.ZeroCodeUnitRunner.class);
    ...
    public Injector getMainModuleInjector() {
        ...
        synchronized (this) {
            ...
            injector = Guice.createInjector(Modules.override(new ApplicationMainModule(serverEnv,null))
                    .with(
...
//            child = smartUtils.jsonFileToJava(currentTestCase, ScenarioSpec.class);
            child = smartUtils.jsonFileToJava(null,null, ScenarioSpec.class);
