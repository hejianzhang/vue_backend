package com.hejianzhang.zerocode.core.engine.listener;
...
public class ZeroCodeTestReportListener extends RunListener {
    private static final org.slf4j.Logger LOGGER = getLogger(com.hejianzhang.zerocode.core.engine.listener.ZeroCodeTestReportListener.class);
