...
package com.hejianzhang.zerocode.core.engine.preprocessor;
...
import static com.hejianzhang.zerocode.core.engine.preprocessor.ZeroCodeTokens.JSON_PAYLOAD_FILE;
import static com.hejianzhang.zerocode.core.utils.SmartUtils.readJsonAsString;
import static com.hejianzhang.zerocode.core.utils.TokenUtils.getTestCaseTokens;
...
public class ZeroCodeExternalFileProcessorImpl implements ZeroCodeExternalFileProcessor {
    private static final Logger LOGGER = getLogger(com.hejianzhang.zerocode.core.engine.preprocessor.ZeroCodeExternalFileProcessorImpl.class);
...
//                            Object jsonFileContent = objectMapper.readTree(readJsonAsString(resourceJsonFile));
                            Object jsonFileContent = objectMapper.readTree(readJsonAsString(null,null));
