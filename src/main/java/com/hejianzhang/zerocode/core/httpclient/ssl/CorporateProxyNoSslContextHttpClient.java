package com.hejianzhang.zerocode.core.httpclient.ssl;
...
public class CorporateProxyNoSslContextHttpClient extends BasicHttpClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.hejianzhang.zerocode.core.httpclient.ssl.CorporateProxyNoSslContextHttpClient.class);
