...
import com.hejianzhang.zerocode.converter.Converter;
import org.json.XML;
...
public class MimeTypeConverter implements Converter {
    ...
    private static final org.slf4j.Logger LOGGER = getLogger(com.hejianzhang.zerocode.converter.MimeTypeConverter.class);
